  ...
  const snapshot = [
    ...
    },
    {
      ...
      "indexes": [
        ...
        "CREATE INDEX `idx_ENq8IGYpDx` ON `business` (\n  `name`,\n  `display_name`\n)"
      ],
      "listRule": "",
      "manageRule": null,
      "mfa": {
    ...
    },
    {
      ...
      "id": "pbc_3745265112",
      "indexes": [
        "CREATE INDEX `idx_6GcskbeiDa` ON `subscribers` (`email`)"
      ],
      "listRule": "",
      "name": "subscribers",
      "system": false,
    ...
    },
    {
      ...
      "id": "pbc_345395871",
      "indexes": [
        "CREATE UNIQUE INDEX `idx_aBnXteaxna` ON `field_settings` (\n  `field_type`,\n  `name`\n)"
      ],
      "listRule": "",
      "name": "field_settings",
      "system": false,
    ...
    },
    {
      ...
      "fields": [
        ...
        {
          "cascadeDelete": true,
          "collectionId": "pbc_1258897888",
          "hidden": false,
          "id": "relation1998225282",
          "maxSelect": 1,
          "minSelect": 0,
          "name": "businsess_field",
          "presentable": false,
          "required": true,
          "system": false,
          "type": "relation"
